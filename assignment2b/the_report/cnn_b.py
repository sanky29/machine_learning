...
con3 = keras.layers.Conv2D(256, (3,3), strides = (1,1), activation = 'relu')(max2)
max3 = keras.layers.MaxPooling2D((2, 2), strides=None, padding='valid')(con3)
layer0 = keras.layers.Flatten()(max3)
